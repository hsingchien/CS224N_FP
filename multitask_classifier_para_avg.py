...
class MultitaskBERT(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.predict_paraphrase_af1 = nn.Linear(BERT_HIDDEN_SIZE,BERT_HIDDEN_SIZE)
        self.predict_paraphrase_af2 = nn.Linear(2 * BERT_HIDDEN_SIZE, 2)
    ...
    def predict_paraphrase(
        ...
        hidden1 = self.predict_paraphrase_af1(hidden1)
        hidden2 = self.predict_paraphrase_af1(hidden2)
